...
class UrlAdapter(val urlList: List<UrlEntity>, val clickListener: (UrlEntity) -> Unit) : RecyclerView.Adapter<UrlAdapter.ViewHolder>()
{
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(url: UrlEntity, clickListener: (UrlEntity) -> Unit) {
            tvUrl.text = url.name

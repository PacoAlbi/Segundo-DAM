...
//        ConexionBBDD.desconectarBBDD();
     ...
     */
    public static void insertarPersona(Jugadores personaAinsertar){
        String sql = String.format("Insert Into Personas values ('%s', '%s', '%s')", personaAinsertar.getNombre());
        try{
